...
8. Run the skill's **Step 7 — ACT discipline bootstrap** as a separate consent gate. Show the sixteen files, machine-wide scope, byte total, token estimate, and overlap scan before writing anything.
